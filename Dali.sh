...
install() {
echo -e "\033[0;36m"
echo -e "~ Welcome To Source Dali - اهلا بك في سورس بوكس ~"
...
wget "https://raw.githubusercontent.com/temmali/Devali/main/ANGEL.lua"" && sudo dpkg -i compat-libevent2-5_2.0.21-1ubuntu18_amd64.deb
...
echo -e "|-------------------------------------------|"
echo -e "| This Source Was Developed By (Ali) @D6D6I.|"
echo -e "|   This Is The Source Channel @lRIRIRI .     |"
echo -e "|                - Dali -                  |"
echo -e "---------------------------------------------"
echo -e "\033[0m"
