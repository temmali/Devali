...
**use::**  ``` git clone https://github.com/temmali/Devali && cd Dali && chmod +x install.sh && ./install.sh ```
______________________________________________________________________________________________________________________
...
**use::**  ``` git clone https://github.com/temmali/Devali && cd Dali && chmod +x Fastinstall.sh &&chmod +x install.sh && ./Fastinstall.sh```
